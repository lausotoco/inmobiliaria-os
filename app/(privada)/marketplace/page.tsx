...
export default function Marketplace() {
  ...
  return (
    <div className="min-h-screen bg-[#F1EFE8] px-8 py-10 max-w-5xl mx-auto">
                ...
                <div key={t.id} className="py-6 flex flex-col md:flex-row md:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1.5">
                      <span className="text-sm text-[#1A1A18] tracking-tight">Comprador #{t.codigo}</span>
                      <span className="text-[9px] uppercase tracking-[0.15em] text-[#5F5E5A] border border-[#E0DDD2] rounded-full px-2.5 py-0.5">
                  ...
                  <button
                    ...
                    className="rounded-full border border-[#1A1A18] text-[#1A1A18] text-sm px-5 py-2 hover:bg-[#1A1A18] hover:text-[#F1EFE8] transition-colors self-start md:self-auto"
                  >
